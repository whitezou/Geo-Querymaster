        ...
        implements Comparable
{
    ...
    private double distance()
    {
        ...
        Geometry geometry1 = geometryFactory.toGeometry((Envelope) boundable1.getBounds());
        Geometry geometry2 = geometryFactory.toGeometry((Envelope) boundable2.getBounds());
