...
//        val points = "/home/runxuan/data/Spatial_Compare/1points_10M_wkt.csv"
...
//    transRDD.origionRDD.persist(StorageLevel.MEMORY_ONLY)
    ...
    //    t0 = System.nanoTime()
    for (i <- 1 to 20) {
      count = transRDD.rangeQuery(rangeQueryWindow6, IndexType.GQT).count()
    ...
    t0 = System.nanoTime()
    for (i <- 1 to nQueries) {
      count1 = transRDD.rangeQuery(rangeQueryWindow1, IndexType.GQT).count()
      //            count1 = transRDD.rangeQuery(rangeQueryWindow1, IndexType.RTREE).count()
    }
    t1 = System.nanoTime()
    ...
    t0 = System.nanoTime()
    for (i <- 1 to nQueries) {
      count1 = transRDD.rangeQuery(rangeQueryWindow2, IndexType.GQT).count()
      //            count1 = transRDD.rangeQuery(rangeQueryWindow2, IndexType.RTREE).count()
    }
    ...
    t0 = System.nanoTime()
    for (i <- 1 to nQueries) {
      count1 = transRDD.rangeQuery(rangeQueryWindow3, IndexType.GQT).count()
      //            count1 = transRDD.rangeQuery(rangeQueryWindow3, IndexType.RTREE).count()
    }
    ...
    t0 = System.nanoTime()
    for (i <- 1 to nQueries) {
      count1 = transRDD.rangeQuery(rangeQueryWindow4, IndexType.GQT).count()
      //            count1 = transRDD.rangeQuery(rangeQueryWindow4, IndexType.RTREE).count()
    }
    ...
    t0 = System.nanoTime()
    for (i <- 1 to nQueries) {
      count1 = transRDD.rangeQuery(rangeQueryWindow5, IndexType.GQT).count()
      //            count1 = transRDD.rangeQuery(rangeQueryWindow5, IndexType.RTREE).count()
    }
    ...
    t0 = System.nanoTime()
    for (i <- 1 to nQueries) {
      count1 = transRDD.rangeQuery(rangeQueryWindow6, IndexType.GQT).count()
      //            count1 = transRDD.rangeQuery(rangeQueryWindow6, IndexType.RTREE).count()
    }
    t1 = System.nanoTime()
    println("Count: " + count1)
    println("Selection Ratio: " + ((count1 * 100.0) / count))
