...
public class GQuadRectangle implements Serializable {
    public final double x, y, width, height;
    public Integer partitionId = null;
    public String lineage = null;

    public GQuadRectangle(Envelope envelope) {
    ...
    public GQuadRectangle(double x, double y, double width, double height) {
        if (width < 0) {
    ...
    public boolean contains(GQuadRectangle r) {
    ...
    */
    ...
    public boolean equals(Object o) {
        if (o == null || !(o instanceof GQuadRectangle)) {
            return false;
        }

        final GQuadRectangle other = (GQuadRectangle) o;
